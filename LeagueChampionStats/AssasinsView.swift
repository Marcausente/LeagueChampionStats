...
struct AssasinsView: View {
    let assassinChampions = [
        ...
        AssassinCharacter(id: 8, name: "LeBlanc, \n the Deceiver", imageName: "LeBlancIcon", lore: "LeBlanc, una maestra de la magia ilusoria, juega con las mentes de sus enemigos."),
        AssassinCharacter(id: 9, name: "Master Yi, \n the Wuju Bladesman", imageName: "MasterYiIcon", lore: "Master Yi, un espadachín wuju, combina velocidad y precisión en cada ataque."),
